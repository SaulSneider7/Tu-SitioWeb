...
export const PromoSection = () => {
    ...
    return (
        <section className="py-12 relative overflow-hidden" data-aos="fade-up">
                ...
                >
                    <div className="bg-black/90 backdrop-blur-xl rounded-[2.9rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 border border-white/10">
                        <div className="flex-1 text-center md:text-left">
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-black text-white mb-4 leading-tight">
                                TU WEB PROFESIONAL <br />
                                <span className="text-purple-400">DESDE S/{finalPrice}</span>
                            </h2>
                            <p className="text-gray-400 text-lg md:text-xl font-medium">
                                No esperes más para digitalizar tu visión con tecnología de élite.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6">
                            <div className="text-center md:text-right">
                                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-sm font-black uppercase tracking-widest mb-2">
                                    <FontAwesomeIcon icon={faComment} className="animate-bounce" /> ASESORÍA GRATIS
                                </div>
                                <p className="text-gray-500 text-xs font-mono">Protocolo de inicio sin costo</p>
                            </div>
                            ...
                            >
                                ¡LO QUIERO! <FontAwesomeIcon icon={faWhatsapp} className="text-2xl group-hover:scale-110 transition-transform" />
                            </a>
                        </div>
                    </div>
                </motion.div>
